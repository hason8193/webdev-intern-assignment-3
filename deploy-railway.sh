...
echo "DEBUG=False"
echo "ALLOWED_HOSTS=your-app.railway.app,localhost,127.0.0.1,healthcheck.railway.app"
echo ""
...
echo ""
echo "Note: healthcheck.railway.app is required for Railway's health checks to work"
